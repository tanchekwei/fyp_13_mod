...
<div class="container" style="padding-top:50px">
    <div class="col-md-12">
        <h2 style="text-align:center;">Student Assessment</h2><br/>

        <form action="studentRubric" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">

                    @php
                        $staffDetail = $assessmentArray[0];
                        $superviseProjectLists = $assessmentArray[1];
                        $moderateProjectLists = $assessmentArray[2];
                    @endphp
                    ...
                    <table class="table table-bordered" style="font-size:14px">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan='3'>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="projectI" name="project" value="projectI" checked>
                                        <label class="form-check-label" for="projectI">Project I</label>
                                    </div>

                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="projectII" name="project" value="projectII">
