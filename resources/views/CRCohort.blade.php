...
<script>
    jQuery(document).ready(function()
    {
        ...
        <div class="container">
            <h1 class="h1 text-center">Create Cohort</h1>
        </div>
        
        <div class="container">
            <div class="modal-body">
                <form method="post" action="{{route('createcohort')}}">
                    @csrf
                <table class="table">
                    <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="cohortid" class="input-group input-group-text" required="required"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>
                            <input type="date" name="p1startdate" id='p1startdate' class="input-group input-group-text" required="required" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class='row'>                                
                                <div class='col-sm-8'> 
                                    <input type="date" name="p1enddate" id='p1enddate' class="input-group input-group-text" readonly="true" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"/>
                                </div>
                                <div class='col-sm-4'>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="date" name="p2startdate" id='p2startdate' class="input-group input-group-text" required="required" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class='row'>
                                <div class='col-sm-8'> 
                                    <input type="date" name="p2enddate" id='p2enddate' class="input-group input-group-text" readonly="true" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"/>
                                </div>
                                <div class='col-sm-4'>
